...
export const CloudSyncModal: React.FC<CloudSyncModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
      <div className="bg-[#12151e] border border-zinc-800 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden flex flex-col">
        {/* Header */}
        ...
        <div className="p-5 text-xs text-zinc-300 space-y-4">
          ...
          <div className="p-3 rounded-xl bg-zinc-900/80 border border-zinc-800 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <span className="font-semibold text-zinc-100 block capitalize">
          ...
          <form onSubmit={handleSaveKey} className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 text-xs font-mono bg-zinc-900 border border-zinc-700/80 rounded-xl px-3 py-2 text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-brand-500/50"
              />
              <button
                type="submit"
          ...
          <div className="pt-2 border-t border-zinc-800 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <button
                type="button"
                onClick={onForcePull}
                className="flex items-center justify-center gap-1.5 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-zinc-200 py-2 px-3 rounded-xl transition"
              ...
              >
                <CloudUpload className="w-3.5 h-3.5 text-brand-400" />
                <span>Push Local</span>
              </button>
            </div>
          </div>

          <div className="p-2.5 rounded-lg bg-zinc-900/60 border border-zinc-800/80 flex items-start gap-2 text-[11px] text-zinc-400">
